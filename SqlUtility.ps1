...
function New-SqlUtilityMainForm {
    ...
    $state = [pscustomobject][ordered]@{
        ...
        DataExplorerOutputInteraction = [pscustomobject][ordered]@{ AllowCheckChange=$false; Prefix=''; ResetTimer=$null }
    ...
    $dataExplorerColumnsLayout=[System.Windows.Forms.TableLayoutPanel]::new();$dataExplorerColumnsLayout.Name='DataExplorerColumnsLayout';$dataExplorerColumnsLayout.Dock=[System.Windows.Forms.DockStyle]::Fill;$dataExplorerColumnsLayout.ColumnCount=1;$dataExplorerColumnsLayout.RowCount=1;[void]$dataExplorerColumnsLayout.ColumnStyles.Add([System.Windows.Forms.ColumnStyle]::new([System.Windows.Forms.SizeType]::Percent,100));[void]$dataExplorerColumnsLayout.RowStyles.Add([System.Windows.Forms.RowStyle]::new([System.Windows.Forms.SizeType]::Percent,100));[void]$dataExplorerBuilderSplit.Panel1.Controls.Add($dataExplorerColumnsLayout)
    $outputs=[System.Windows.Forms.CheckedListBox]::new();$outputs.Name='OutputColumnsList';$outputs.CheckOnClick=$false;$outputs.Dock=[System.Windows.Forms.DockStyle]::Fill;$outputs.HorizontalScrollbar=$false;$outputs.IntegralHeight=$false;[void]$dataExplorerColumnsLayout.Controls.Add($outputs,0,0)
    $all=[System.Windows.Forms.Button]::new();$all.Name='SelectAllColumnsButton';$all.Text='All';$all.AutoSize=$true;$all.AutoSizeMode=[System.Windows.Forms.AutoSizeMode]::GrowAndShrink
    $none=[System.Windows.Forms.Button]::new();$none.Name='SelectNoColumnsButton';$none.Text='None';$none.AutoSize=$true;$none.AutoSizeMode=[System.Windows.Forms.AutoSizeMode]::GrowAndShrink
    ...
    $dataExplorerActionLayout=[System.Windows.Forms.TableLayoutPanel]::new();$dataExplorerActionLayout.Name='DataExplorerActionLayout';$dataExplorerActionLayout.Dock=[System.Windows.Forms.DockStyle]::Fill;$dataExplorerActionLayout.AutoSize=$true;$dataExplorerActionLayout.ColumnCount=6;$dataExplorerActionLayout.RowCount=1;[void]$dataExplorerActionLayout.ColumnStyles.Add([System.Windows.Forms.ColumnStyle]::new([System.Windows.Forms.SizeType]::AutoSize));[void]$dataExplorerActionLayout.ColumnStyles.Add([System.Windows.Forms.ColumnStyle]::new([System.Windows.Forms.SizeType]::AutoSize));[void]$dataExplorerActionLayout.ColumnStyles.Add([System.Windows.Forms.ColumnStyle]::new([System.Windows.Forms.SizeType]::Percent,100));[void]$dataExplorerActionLayout.ColumnStyles.Add([System.Windows.Forms.ColumnStyle]::new([System.Windows.Forms.SizeType]::AutoSize));[void]$dataExplorerActionLayout.ColumnStyles.Add([System.Windows.Forms.ColumnStyle]::new([System.Windows.Forms.SizeType]::AutoSize));[void]$dataExplorerActionLayout.ColumnStyles.Add([System.Windows.Forms.ColumnStyle]::new([System.Windows.Forms.SizeType]::AutoSize));[void]$dataExplorerBuilderLayout.Controls.Add($dataExplorerActionLayout,0,1)
    [void]$dataExplorerActionLayout.Controls.Add($all,0,0)
    [void]$dataExplorerActionLayout.Controls.Add($none,1,0)
    $preview=[System.Windows.Forms.Button]::new();$preview.Name='PreviewButton';$preview.Text='Preview';$preview.AutoSize=$true;$preview.Enabled=$false;[void]$dataExplorerActionLayout.Controls.Add($preview,3,0)
    $exportPreview=[System.Windows.Forms.Button]::new();$exportPreview.Name='ExportPreviewButton';$exportPreview.Text='Export Preview';$exportPreview.AutoSize=$true;$exportPreview.Enabled=$false;[void]$dataExplorerActionLayout.Controls.Add($exportPreview,4,0)
    $send=[System.Windows.Forms.Button]::new();$send.Name='SendToQueryButton';$send.Text='Send to Query';$send.AutoSize=$true;$send.Enabled=$false;[void]$dataExplorerActionLayout.Controls.Add($send,5,0)
